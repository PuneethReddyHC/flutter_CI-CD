...
class AppThemeData {
  ...
  static final TextTheme _textTheme = TextTheme(
    headlineSmall: GoogleFonts.montserrat(fontWeight: _bold, fontSize: 20.0),
    bodySmall: GoogleFonts.oswald(fontWeight: _semiBold, fontSize: 16.0),
    headlineMedium: GoogleFonts.oswald(fontWeight: _medium, fontSize: 16.0),
    titleMedium: GoogleFonts.montserrat(fontWeight: _medium, fontSize: 16.0),
    displaySmall: GoogleFonts.montserrat(fontWeight: _medium, fontSize: 12.0),
